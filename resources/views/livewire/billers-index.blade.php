<div>
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <button class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 text-white text-[13px] font-semibold rounded-lg hover:bg-slate-700 transition-colors">+ Add Biller</button>
    </div>
