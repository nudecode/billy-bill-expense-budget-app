<div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <button wire:click="openCreate()"
            ...
            <i class="fa-solid fa-plus text-xs"></i> Add Recurring Income
        </button>
    </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-200">
                        ...
                        <th class="text-left px-5 py-3 text-[10.5px] font-bold uppercase tracking-widest text-slate-400 hidden lg:table-cell">Status</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                    <tr><td colspan="7" class="px-5 py-10 text-center text-slate-400 text-[13px]">No recurring income yet. Add one to get started.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="relative bg-white w-full sm:max-w-lg rounded-t-2xl sm:rounded-2xl shadow-xl z-10"
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100">
                <div class="flex items-center gap-2.5">
                    <div class="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center">
                        <i class="fa-solid fa-repeat text-blue-500 text-sm"></i>
                    </div>
                    <h2 class="text-[15px] font-bold text-slate-900">{{ $editingId ? 'Edit Recurring Income' : 'Add Recurring Income' }}</h2>
                </div>
            ...
            <div class="px-5 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div>
                    ...
                    <input wire:model="name" type="text" placeholder="e.g. Salary, Rental Income"
                           class="w-full px-3 py-2 border border-slate-200 rounded-lg text-[13.5px] focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-500 transition-all @error('name') border-red-400 @enderror">
            ...
            <div class="flex items-center justify-end gap-3 px-5 py-4 border-t border-slate-100">
                ...
                <button wire:click="save()" wire:loading.attr="disabled" wire:target="save"
                    ...
                    <span wire:loading.remove wire:target="save">{{ $editingId ? 'Save Changes' : 'Create Income' }}</span>
        ...
        <div class="relative bg-white w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl shadow-xl z-10"
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100">
                <div class="flex items-center gap-2.5">
                    ...
                    <h2 class="text-[15px] font-bold text-slate-900">End or Delete Recurring Income</h2>
                </div>
            ...
            <div class="px-5 py-4 space-y-4">
                <p class="text-[13.5px] text-slate-600 leading-relaxed">
                    Ending keeps this income showing in past months but stops new occurrences after the end date.
                    Deleting removes it from every month, past and future, and can't be undone.
                </p>
                ...
                <div class="border-t border-slate-100 pt-4">
                    <button wire:click="deleteRule()" wire:loading.attr="disabled" wire:target="deleteRule"
                            class="w-full px-4 py-2.5 bg-red-50 border border-red-200 text-red-600 text-[13px] font-semibold rounded-lg hover:bg-red-100 transition-all disabled:opacity-60">
                        <span wire:loading.remove wire:target="deleteRule"><i class="fa-regular fa-trash-can mr-1.5"></i>Delete Permanently</span>
